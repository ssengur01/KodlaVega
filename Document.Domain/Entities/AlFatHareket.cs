...
namespace Document.Domain.Entities
{
    public class AlFatHareket
    {
        ...
        public decimal? HurdaIndirimi { get; set; }
        ...
        public decimal? GrupMiktar { get; set; }
        public decimal? TartilanMiktar { get; set; }
        public decimal? Mf { get; set; }
        public decimal? ItSisK1 { get; set; }
        public decimal? ItSisK2 { get; set; }
        public decimal? ItSisK3 { get; set; }
        public decimal? ItSisK4 { get; set; }
        public decimal? OrjFiyat { get; set; }
        ...
        public decimal? Kdv_ExMaTrahi { get; set; }
        public int? SatirNo { get; set; }
        public bool? TevkiFatUyg { get; set; }
        public decimal? TevkiFatTutar { get; set; }
        public int? LinkBelgeInd { get; set; }
        public int? LinkBelgeIzahat { get; set; }
        public string? KampanyaAciklamasi { get; set; }
      //  public AlFatBaslik? AlFatBaslik { get; set; }
    }
}
