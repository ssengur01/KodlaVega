...
namespace StockDocument.Infrastructure.Data
{
    public class StockDbContext : DbContext
    {
        ...
        public StockDbContext(DbContextOptions<StockDbContext> options, FirmaDonemContext firmaContext)
        : base(options)
        {
            _firmaInd = "101";
            _donemInd = "0003";
        ...
        public DbSet<StkGirBaslik> StkGirBasliklar { get; set; }
        public DbSet<StkGirHareket> StkGirHareketler { get; set; }
        public DbSet<StkCikBaslik> StkCikBasliklar { get; set; }
        public DbSet<StkCikHareket> StkCikHareketler { get; set; }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<StkGirBaslik>(entity =>
            {              
                entity.ToTable($"F0{_firmaInd}D{_donemInd}TBLSTKGIRBASLIK");             
                entity.HasKey(e => e.IND);              
                entity.Property(e => e.IND).HasColumnName("IND");
                entity.Property(e => e.FIRMAADI).HasColumnName("FIRMAADI").HasMaxLength(150);
                ...
                entity.Property(e => e.KALEM1).HasColumnName("KALEM1");
                entity.Property(e => e.KALEM2).HasColumnName("KALEM2");
                entity.Property(e => e.KALEM3).HasColumnName("KALEM3");
                entity.Property(e => e.KALEM4).HasColumnName("KALEM4");
            ...
            modelBuilder.Entity<StkGirHareket>(entity =>
            {               
                entity.ToTable($"F0{_firmaInd}D{_donemInd}TBLSTKGIRHAREKET");
                entity.HasKey(e => e.Ind);              
                entity.Property(e => e.Ind).HasColumnName("IND");
                entity.Property(e => e.Tarih).HasColumnName("TARIH");
                ...
                entity.Property(e => e.MalinCinsi).HasColumnName("MALINCINSI").HasMaxLength(150);
                ...
                entity.Property(e => e.Uıd).HasColumnName("UID").HasMaxLength(100);
            ...
            modelBuilder.Entity<StkCikBaslik>(entity =>
            {
                entity.ToTable($"F0{_firmaInd}D{_donemInd}TBLSTKCIKBASLIK");
                entity.HasKey(e => e.IND);
                entity.Property(e => e.IND).HasColumnName("IND");
                entity.Property(e => e.FIRMAADI).HasColumnName("FIRMAADI").HasMaxLength(150);
                entity.Property(e => e.TUTAR).HasColumnName("TUTAR").HasColumnType("decimal(28,8)");
            ...
            modelBuilder.Entity<StkCikHareket>(entity =>
            {
                entity.ToTable($"F0{_firmaInd}D{_donemInd}TBLSTKCIKHAREKET");
                entity.HasKey(e => e.Ind);
                entity.Property(e => e.Ind).HasColumnName("IND");
                entity.Property(e => e.Tarih).HasColumnName("TARIH");
                entity.Property(e => e.Detay).HasColumnName("DETAY");
