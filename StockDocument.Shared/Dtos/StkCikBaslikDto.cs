...
namespace StockDocument.Shared.Dtos
{
    public class StkCikBaslikDto
    {
        ...
        public StkCikBaslikDto(StkCikBaslik entity)
        {
            ...
            TARIH = entity.TARIH;
            BELGETIPI = (StockType?)entity.BELGETIPI;
        }
    }
}
