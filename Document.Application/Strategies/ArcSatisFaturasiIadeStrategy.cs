...
{
    public class ArcSatisFaturasiIadeStrategy : IDocumentStrategy<SatFatBaslikDto>
    {
        private readonly IInvoiceRepository _repository;

        public ArcSatisFaturasiIadeStrategy(IInvoiceRepository repository)
        {
        ...
        public List<SatFatBaslikDto> List()
        {
            return _repository.SatFatBasliks
                .Where(f => f.BELGETIPI.HasValue && f.BELGETIPI.Value == (short)InvoiceType.ArcSatFatIade)
