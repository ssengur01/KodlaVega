...
{
    public class PosFisStrategy : IDocumentStrategy<AlFatBaslikDto>
    {
        private readonly IInvoiceRepository _repository;

        public PosFisStrategy(IInvoiceRepository repository)
        {
        ...
        public List<AlFatBaslikDto> List()
        {
            return _repository.AlFatBasliks
                .Where(f => f.BELGETIPI.HasValue && f.BELGETIPI.Value == (short)InvoiceType.PosFiş)
