...
{
    public class ArcAlisIadeFaturasıStrategy : IDocumentStrategy<AlFatBaslikDto>
    {
        private readonly IInvoiceRepository _repository;

        public ArcAlisIadeFaturasıStrategy(IInvoiceRepository repository)
        {
        ...
        public List<AlFatBaslikDto> List()
        {
            return _repository.AlFatBasliks
                .Where(f => f.BELGETIPI.HasValue && f.BELGETIPI.Value == (short)InvoiceType.ArcAlIadeFat)
